    ...
    <div className="site-shell">
      <header className={`header ${scrolled ? 'header--scrolled' : ''}`}>
        <a className="brand" href="#top" onClick={closeMenu} aria-label="Jorge Koch — início">
          <img src="/src/assets/logo-compacta.png" alt="Jorge Koch Dev" />
        </a>
        ...
        <nav className={`nav ${menuOpen ? 'nav--open' : ''}`}>
          ...
          <a href="#contato" onClick={closeMenu} className="nav-cta">Vamos conversar <span>↗</span></a>
        </nav>
      </header>
      ...
      <main id="top">
        <section className="hero">
          ...
          <div className="hero-content">
            ...
            <div className="hero-actions">
              <a href="#trabalho" className="button button--primary">Ver meu trabalho <span>↓</span></a>
              <a href="#sobre" className="button button--ghost">Conhecer o processo <span>↗</span></a>
            </div>
          </div>
          <div className="hero-mark" aria-hidden="true">
            <span>JK</span>
            <small>DEV / 2026</small>
          </div>
        ...
        <section className="statement">
          ...
          <div className="statement-copy">
            ...
            <h2>Crio <span>presença digital</span> para pessoas e marcas que querem ser lembradas.</h2>
          </div>
        ...
        <section className="work" id="trabalho">
          <div className="section-heading">
            <div>
              <div className="section-label">02 — Projetos selecionados</div>
              <h2>Feito na prática<span>.</span></h2>
            </div>
          ...
          <div className="project-list">
            {projects.map((project) => (
              <a className={`project-card project-card--${project.accent}`} href={project.url} target="_blank" rel="noreferrer" key={project.number}>
                <div className="project-visual">
                  <div className="browser-bar"><i /><i /><i /><span>{project.title.toLowerCase().replaceAll(' ', '')}.web</span></div>
        ...
        <section className="about" id="sobre">
          <div className="section-label">03 — Quem está por trás</div>
          <div className="about-grid">
            ...
            <div className="about-copy">
              <h2>Desenvolvedor com olhar de designer.</h2>
        ...
        <section className="process">
          <div className="section-label">04 — Como eu trabalho</div>
          <div className="process-grid">
            {[
              ...
              <article key={num} className="process-item">
        ...
        <section className="contact" id="contato">
          ...
          <div className="contact-inner">
            ...
            <h2>Tem uma ideia<br /><em>na cabeça?</em></h2>
            <p>Vamos tirar do papel e colocar na internet.</p>
            <a className="contact-button" href="https://github.com/jorgekoch" target="_blank" rel="noreferrer">Falar com Jorge <span>↗</span></a>
          </div>
          <div className="contact-footer">
            <span>JORGE KOCH / DEV</span>
            <span>© 2026</span>
            <a href="https://github.com/jorgekoch" target="_blank" rel="noreferrer">GitHub ↗</a>
          </div>
        </section>
      </main>
    </div>
